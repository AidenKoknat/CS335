...
public class ImageRotate extends JFrame {
        ...
        fileopen.addActionListener(
                new ActionListener () {
                    public void actionPerformed (ActionEvent e) {
                        int returnVal = fc.showOpenDialog(ImageRotate.this);
    ...
    private void buildComponents() {
        ...
        view = new MyImageObj(readImage("coolDoge.jpg"));
        //view = new MyImageObj();
        ...
        rotateSlider = new JSlider( SwingConstants.HORIZONTAL, -360, 360, 10);
        rotateSlider.setMajorTickSpacing(10);
        rotateSlider.setPaintTicks(true);
        rotateSlider.addChangeListener(
                new ChangeListener() {
                    public void stateChanged (ChangeEvent e) {
                        //view.ThresholdImage(rotateSlider.getValue());
                        rotation = rotateSlider.getValue();
                        view.ApplyAffine(rotation);
                        rotateLabel.setText("Rotated Image");
                        rotateLabel.setText("Rotate Value: " +
                                Integer.toString(rotateSlider.getValue()));
                    }
                }
        );
        // End Edits
